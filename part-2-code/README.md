...
```
conda create -n hw4-part-2-nlp python=3.10 -y
...
```
python evaluate.py \
  --predicted_sql results/t5_ft_ft_experiment_dev.sql \
  --predicted_records records/t5_ft_ft_experiment_dev.pkl \
...
python train_t5.py \
    ...
    --weight_decay 0.01 \
    --use_wandb \
    --experiment_name "finetune_linear_2e-4"
